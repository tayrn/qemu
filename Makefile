...
qemu-oslib.dtrace.o: trace-dtrace.dtrace $(qemu-oslib-trace-objs)
	$(call DTRACE,$@,trace-dtrace.dtrace,$(qemu-oslib-trace-objs))
...
fsdev/virtfs-proxy-helper$(EXESUF): fsdev/virtfs-proxy-helper.o fsdev/virtio-9p-marshal.o $(qemu-oslib-all-objs) $(trace-obj-y)
